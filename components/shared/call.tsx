...
export const Call = () => {
  ...
  return (
      ...
      {({ open }) => (
        <>
          ...
          >
            ...
            <a className="px-2 py-1 " href="tel:+380504475198">
              +380504475198
            </a>
          ...
          >
            <Popover.Panel className="absolute z-10 w-48 px-4 mt-3 transform -translate-x-1/2 left-1/2 sm:px-0">
              <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                <div className="flex items-center p-4 text-center bg-gray-50">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    className="w-4 mr-4"
                  ...
                  <a href="viber://chat?number=%2B380504475198">Viber</a>
                </div>
                <div className="flex items-center p-4 text-center bg-gray-50">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
    ...
    //       <path d="M16 64C16 28.7 44.7 0 80 0H304c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H80c-35.3 0-64-28.7-64-64V64zM144 448c0 8.8 7.2 16 16 16h64c8.8 0 16-7.2 16-16s-7.2-16-16-16H160c-8.8 0-16 7.2-16 16zM304 64H80V384H304V64z" />
    //     </svg>
    //     <a className="px-2 py-1 text-2xl font-bold" href="tel:+380504475198">
    //       +380504475198
    //     </a>
