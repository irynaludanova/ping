export const en = {
  ...
  palio_carbon:
    "This popular attacking blade from Palio excels in offense and provides excellent speed dynamics. Playing with the PALIO T3 Carbon blade, you can easily show your strengths by performing top spins, rolls or straight shots. The presence of carbon layers in the construction of the blade provides sufficient speed and the formation of the maximum zone of the best rebound on the playing surface of the blade. The center layer of the base is softer and this creates a high level of control. When playing with this blade, you can literally “feel” the ball and send it to any point on the table at high speed. The advantages of PALIO T3 Carbon also include an unsurpassed price-quality ratio.",
  friend:
